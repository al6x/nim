...
How it works: the UI is created and operates within the Nim C-process, the Mono binds it to Web/Desktop/Mobile UI. Similarly to remote desktop, with high efficiency, as only UI changes are transmitted.
