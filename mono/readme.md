...
Radical simplification, no Network, no JS, no "compile-to-JS", no Client, no Server, no API, no N+1 problem.

Write Plain Nim code and plain Nim C-runtime, Mono turns it into fluid interactive Web UI.
